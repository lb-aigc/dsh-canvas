...
export function resolveImagePickerModels(value) {
    const v = (value ?? {});
    const rawModels = Array.isArray(v.models) && v.models.length > 0
        ? v.models
    ...
    const defaultKey = normalizeDefaultKey(typeof v.default === 'string' ? v.default : '', keyed, IMAGE_PRESETS) || models[0]?.key || DEFAULT_PROVIDER;
    return {
