...
function CanvasNodeCard({ id, data }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "ldd-canvas-node", "data-kind": data.kind, children: [_jsx("button", { type: "button", className: "ldd-canvas-node-delete nodrag", title: "\u5220\u9664\u8282\u70B9", "aria-label": `删除「${data.label}」`, onClick: (event) => {
                        ...
                        : _jsxs("div", { className: "ldd-canvas-node-image ldd-canvas-image-placeholder", style: { width: 240, height: 180 }, children: [kindIcon('image'), "\u56FE\u7247"] })), data.kind === 'video' && (_jsxs("div", { className: "ldd-canvas-node-image ldd-canvas-image-placeholder", style: { width: 240, height: 180 }, children: [kindIcon('video'), "\u89C6\u9891"] })), data.kind === 'music' && (_jsxs("div", { className: "ldd-canvas-node-media", children: [_jsx("span", { className: "ldd-canvas-node-media-glyph", children: kindIcon('music') }), _jsx("span", { className: "ldd-canvas-node-media-caption", children: "\u97F3\u9891\u7D20\u6750" })] })), hasTextBody && (_jsx("div", { className: "ldd-canvas-node-text", children: data.content === undefined || data.content === ''
                            ? _jsx("span", { className: "ldd-canvas-node-text-empty", children: "\uFF08\u65E0\u5185\u5BB9\uFF09" })
                            : data.content })), _jsx("div", { className: "ldd-canvas-node-label", children: data.label })] }), _jsx(Handle, { type: "target", position: Position.Left, className: "ldd-canvas-handle", children: _jsx("svg", { className: "ldd-canvas-handle-plus", viewBox: "0 0 16 16", "aria-hidden": "true", focusable: "false", children: _jsx("path", { d: "M8 3.5v9M3.5 8h9" }) }) }), _jsx(Handle, { type: "source", position: Position.Right, className: "ldd-canvas-handle", children: _jsx("svg", { className: "ldd-canvas-handle-plus", viewBox: "0 0 16 16", "aria-hidden": "true", focusable: "false", children: _jsx("path", { d: "M8 3.5v9M3.5 8h9" }) }) })] }));
}
...
export function CanvasView({ useProjection, loadImage, addNodeToInput, compose, pickFiles, uploadFiles, addNode, removeNode, updateNode, moveNode, link }) {
    ...
    const onNodesChange = useCallback((changes) => {
        ...
        for (const change of changes) {
            if (change.type === 'remove')
                run('removeNode', removeNode(change.id));
        }
    ...
    const saveEdit = () => {
        ...
        if (Object.keys(patch).length > 0)
            run('updateNode', updateNode(selected.id, patch));
        setSelected(null);
    };
    ...
    return (_jsx(LoadImageContext.Provider, { value: loadImage, children: _jsx(CanvasActionsContext.Provider, { value: actions, children: _jsxs("div", { className: "ldd-canvas-root", ref: rootRef, onDragEnter: onCanvasDragEnter, onDragOver: onCanvasDragOver, onDragLeave: onCanvasDragLeave, onDrop: (event) => { void onCanvasDrop(event); }, children: [_jsxs(ReactFlow, { nodes: displayNodes, edges: displayEdges, nodeTypes: nodeTypes, onInit: (rf) => { rfRef.current = rf; }, onNodesChange: onNodesChange, onEdgesChange: onEdgesChange, onNodeDragStop: onDragStop, onConnect: onConnect, onConnectStart: onConnectStart, onConnectEnd: onConnectEnd, onNodeContextMenu: onNodeContextMenu, 
                        ...
                        panOnDrag: [2], selectionOnDrag: true, selectionMode: SelectionMode.Full, onNodeClick: (_, node) => {
                            ...
                            : (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", onClick: () => { void addDownstream('image'); }, children: "\u56FE\u7247" }), _jsx("button", { type: "button", onClick: () => { void addDownstream('video'); }, children: "\u89C6\u9891" })] })) })), nodeMenu !== null && (_jsxs("div", { className: "ldd-canvas-menu ldd-canvas-node-menu", style: { left: nodeMenu.x, top: nodeMenu.y }, children: [_jsx("button", { type: "button", onClick: () => { deleteNodeById(nodeMenu.nodeId); }, children: "\u5220\u9664" }), _jsx("button", { type: "button", onClick: () => { duplicateNode(nodeMenu.nodeId); }, children: "\u590D\u5236" }), _jsx("button", { type: "button", onClick: () => { handleAddToInput(nodeMenu.nodeId); }, children: "\u6DFB\u52A0\u81F3\u8F93\u5165\u6846" })] })), selected !== null && (_jsxs("div", { className: "ldd-canvas-edit", children: [_jsxs("div", { className: "ldd-canvas-edit-row", children: [_jsxs("span", { className: "ldd-canvas-edit-kind", children: [kindIcon(selected.kind), _jsx("span", { children: KIND_LABEL[selected.kind] })] }), _jsx("input", { className: "ldd-canvas-edit-label", value: draftLabel, onChange: (event) => setDraftLabel(event.target.value), onKeyDown: (event) => { if (event.key === 'Enter')
                                            saveEdit(); }, placeholder: "\u8282\u70B9\u6807\u9898" }), _jsx("button", { type: "button", className: "ldd-canvas-edit-save", onClick: saveEdit, children: "\u4FDD\u5B58" }), _jsx("button", { type: "button", className: "ldd-canvas-edit-delete", onClick: deleteSelected, children: "\u5220\u9664" })] }), (selected.kind === 'text' || selected.kind === 'note') && (_jsx("textarea", { className: "ldd-canvas-edit-content", value: draftContent, onChange: (event) => setDraftContent(event.target.value), placeholder: "\u5185\u5BB9\u2026", rows: 3 }))] })), _jsxs("div", { className: "ldd-canvas-composer", children: [composeFiles.length > 0 && (_jsx("div", { className: "ldd-canvas-composer-attachments", children: composeFiles.map((file, index) => (_jsxs("span", { className: "ldd-canvas-composer-chip", title: file.name, children: [file.name, _jsx("button", { type: "button", className: "ldd-canvas-composer-chip-remove", "aria-label": `移除 ${file.name}`, onClick: () => setComposeFiles((prev) => prev.filter((_, i) => i !== index)), children: "\u00D7" })] }, index))) })), _jsxs("div", { className: "ldd-canvas-composer-row", children: [_jsx("button", { type: "button", className: "ldd-canvas-composer-attach", title: "\u6DFB\u52A0\u56FE\u7247", "aria-label": "\u6DFB\u52A0\u56FE\u7247", onClick: () => { void pickComposeImages(); }, children: _jsx("svg", { viewBox: "0 0 16 16", width: "14", height: "14", "aria-hidden": "true", focusable: "false", children: _jsx("path", { d: "M8 3.5v9M3.5 8h9" }) }) }), _jsx("textarea", { className: "ldd-canvas-composer-input", value: composeText, onChange: (event) => setComposeText(event.target.value), onKeyDown: onComposeKeyDown, placeholder: "\u7ED9 agent \u53D1\u9001\u6D88\u606F\u2026\uFF08Enter \u53D1\u9001\uFF0CShift+Enter \u6362\u884C\uFF09", rows: 1 }), _jsx("button", { type: "button", className: "ldd-canvas-composer-send", onClick: doComposeSubmit, disabled: composeText.trim() === '' && composeFiles.length === 0, children: "\u53D1\u9001" })] })] })] }) }) }));
}
