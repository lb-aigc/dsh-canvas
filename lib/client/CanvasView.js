...
export function CanvasView({ useProjection, loadImage, ask, pickFiles, uploadFiles, addNode, removeNode, updateNode, moveNode, link }) {
    ...
    return (_jsx(LoadImageContext.Provider, { value: loadImage, children: _jsx(CanvasActionsContext.Provider, { value: actions, children: _jsxs("div", { className: "ldd-canvas-root", onDragEnter: onCanvasDragEnter, onDragOver: onCanvasDragOver, onDragLeave: onCanvasDragLeave, onDrop: (event) => { void onCanvasDrop(event); }, children: [_jsxs(ReactFlow, { nodes: displayNodes, edges: displayEdges, nodeTypes: nodeTypes, onInit: (rf) => { rfRef.current = rf; }, onNodesChange: onNodesChange, onEdgesChange: onEdgesChange, onNodeDragStop: onDragStop, onConnect: onConnect, onConnectStart: onConnectStart, onConnectEnd: onConnectEnd, 
                        ...
                        }, children: [_jsxs("span", { style: { flex: 1, wordBreak: 'break-all' }, children: ["\u753B\u5E03\u5199\u56DE\u5931\u8D25\uFF1A", writebackError] }), _jsx("button", { type: "button", onClick: () => setWritebackError(null), style: { background: 'transparent', border: 'none', color: '#fff', cursor: 'pointer', fontSize: 16, lineHeight: 1 }, children: "\u00D7" })] })), canvas.nodes.length === 0 && (_jsx("div", { className: "ldd-canvas-empty-hint", children: "\u753B\u5E03\u4E3A\u7A7A\u3002\u53CC\u51FB\u753B\u5E03\u4E0A\u4F20\u56FE\u7247/\u97F3\u9891/\u89C6\u9891\uFF0C\u6216\u5728\u5BF9\u8BDD\u4E2D\u8BA9\u667A\u80FD\u4F53\u5F80\u753B\u5E03\u6DFB\u52A0\u5185\u5BB9\u3002" })), menu !== null && (_jsxs("div", { className: "ldd-canvas-menu", style: { left: menu.x, top: menu.y }, children: [_jsx("button", { type: "button", onClick: () => { void uploadAssets('image'); }, children: "\u4E0A\u4F20\u56FE\u7247" }), _jsx("button", { type: "button", onClick: () => { void uploadAssets('music'); }, children: "\u4E0A\u4F20\u97F3\u9891" }), _jsx("button", { type: "button", onClick: () => { void uploadAssets('video'); }, children: "\u4E0A\u4F20\u89C6\u9891" })] })), selected !== null && (_jsxs("div", { className: "ldd-canvas-edit", children: [_jsxs("div", { className: "ldd-canvas-edit-row", children: [_jsxs("span", { className: "ldd-canvas-edit-kind", children: [kindIcon(selected.kind), _jsx("span", { children: KIND_LABEL[selected.kind] })] }), _jsx("input", { className: "ldd-canvas-edit-label", value: draftLabel, onChange: (event) => setDraftLabel(event.target.value), onKeyDown: (event) => { if (event.key === 'Enter')
